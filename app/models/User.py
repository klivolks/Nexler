...
class User:
    ...
    def save(self):
        if self._id is None:  
            ...
            # Remove None values from data
            data = {k: v for k, v in data.items() if v is not None}
            result = self.user.set({'_id': self._id},data)
