...
def create_schema(args):
    ...
    {"Variable": "CreatedAt", "Format": "datetime", "Required": false, "Default": "Field(default_factory=lambda: date_util.get_current_time())"},
    {"Variable": "UpdatedAt", "Format": "datetime", "Required": true, "Default": "Field(default_factory=lambda: date_util.get_current_time())"},
